...
const translations = {
  en: {
    ...
    runtimeMessages: {
      ...
      'Cancelling processing.': 'Cancelling processing.',
  ...
  ru: {
    ...
    runtimeMessages: {
      ...
      'Cancelling processing.': 'Отмена обработки.',
  ...
  ua: {
    ...
    runtimeMessages: {
      ...
      'Cancelling processing.': 'Скасування обробки.',
      'Processing cancelled.': 'Обробку скасовано.',
